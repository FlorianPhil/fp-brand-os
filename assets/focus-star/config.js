  ...
  "pillars": [
    {
      ...
      "case": {
        "desc": "<strong>Brand Therapy.</strong> Brand Therapy is brand strategy with psychology built in. A diagnostic and business positioning practice for leaders, producing the working blueprint that turns hidden expertise into clarity impossible to ignore.",
    ...
    },
    {
      ...
      "case": {
        "desc": "<strong>The Invisible Expert.</strong> Brand Therapy is for The Invisible Expert: someone with real taste, standards, and expertise whose public brand has not caught up to the quality of the work.",
    ...
    },
    {
      ...
      "case": {
        "desc": "<strong>Make every brand unique.</strong> FP exists to reveal the brand truth that already exists in each client, and make it strong enough to say no. The authenticity already exists. The work is revealing it, helping the brand own it, and making it the foundation for every decision.",
    ...
    },
    {
      ...
      "case": {
        "desc": "<strong>Curiosity.</strong> Curiosity is the non-negotiable operating method: look closely before deciding, ask the question that reveals what is actually there, and make every choice trace back to what is real rather than what is performed.",
    ...
    },
    {
      ...
      "case": {
        "desc": "<strong>Funny first, dry diagnosis.</strong> FP sounds funny because the diagnosis is precise, not because every line performs. The voice finds the absurdity inside the truth. Humor is how the insight arrives, not a decoration after it.",
